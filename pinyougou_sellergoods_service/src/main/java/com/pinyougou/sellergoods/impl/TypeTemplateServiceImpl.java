...
public class TypeTemplateServiceImpl implements TypeTemplateService {
    ...
    public List<Map> findSpecList(Long id) {
        ...
        //把json串转成List<Map>
        List<Map> mapsList = JSON.parseArray(tbTypeTemplate.getSpecIds(), Map.class);
    ...
    public void saveToRedis() {
        ...
        for (TbTypeTemplate tbTypeTemplate : tbTypeTemplateList) {
            ...
            redisTemplate.boundHashOps("brandIds").put(tbTypeTemplate.getId(), brandList);
            //缓存规格列表
            List<Map> specList = findSpecList(tbTypeTemplate.getId());
            redisTemplate.boundHashOps("specIds").put(tbTypeTemplate.getId(), specList);
        }
    }
